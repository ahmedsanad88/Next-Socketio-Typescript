...
const Index: React.FC = () => {
  ...
  return (
    <div className="flex flex-col w-full h-screen">
      <div className="py-4 text-white bg-gray-900 sticky top-0">
        <h1 className="text-center text-2xl font-semibold">Chat App</h1>
        <h2 className="mt-2 text-center">
          Made with love &#10084; by SuiizTech Team.
        </h2>
      </div>
      <div className="flex flex-col flex-1 bg-gray-700">
        <div className="flex-1 p-4 font-mono">
          {chat.length ? (
            chat.map((chat, i) => (
              ...
              >
                <p
                  className={`px-4 py-2 text-white shadow-lg mb-2 rounded-full w-fit ${
                    chat.user === user ? " bg-blue-600" : " bg-gray-900"
                  }`}
                >
                  {chat.msg}
                </p>
        ...
        <div className="bg-gray-900 p-4 h-20 sticky bottom-0">
